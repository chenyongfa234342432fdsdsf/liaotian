...
function Popconfirm(baseProps, ref) {
    ...
    var renderPopconfirmContent = function () {
        ...
        return (React.createElement("div", { className: prefixCls + "-wrapper" },
            ...
            React.createElement("div", { className: prefixCls + "-btn" }, focusLock ? (React.createElement(FocusLock, { crossFrame: false, disabled: !popupVisible, autoFocus: !!autoFocus }, element)) : (element))));
    };
    useEffect(function () {
