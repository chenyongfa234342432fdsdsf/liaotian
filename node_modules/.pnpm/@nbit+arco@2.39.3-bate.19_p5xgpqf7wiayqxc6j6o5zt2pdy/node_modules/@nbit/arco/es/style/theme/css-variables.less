...
@{arco-theme-tag} {
  ...
  @{arco-cssvars-prefix}-color-neutral-10: #101014;
  ...
  @{arco-cssvars-prefix}-input-bg: @input-bg;
}
...
@{arco-theme-tag} {
  &[arco-theme='dark'] {
    ...
    @{arco-cssvars-prefix}-input-bg: @dark-input-bg;
    @{arco-cssvars-prefix}-color-neutral-10: #ffffff;
  }
}
