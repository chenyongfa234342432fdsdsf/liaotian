...
function Column(_a) {
    ...
    var cellChildren = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        shouldRenderFilters && (react_1.default.createElement(Trigger_1.default, __assign({ popup: renderFilters, trigger: "click", classNames: "slideDynamicOrigin", position: rtl ? 'bl' : 'br', popupAlign: { bottom: 0 }, popupVisible: filterVisible, onVisibleChange: onVisibleChange }, filterDropdownTriggerProps),
