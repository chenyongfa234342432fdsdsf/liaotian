...
var Notification = /** @class */ (function (_super) {
    ...
    Notification.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: classNames },
            react_1.default.createElement(react_transition_group_1.TransitionGroup, { component: null }, notices.map(function (notice) { return (react_1.default.createElement(react_transition_group_1.CSSTransition, { key: notice.id, timeout: {
                ...
                react_1.default.createElement(notice_1.default, __assign({}, notice, { onClose: _this.remove, prefixCls: prefixClsNotification, iconPrefix: prefixCls, noticeType: "notification", rtl: rtl })))); }))));
    };
    ...
    Notification.addInstance = function (noticeProps) {
        ...
        (0, react_dom_1.render)(react_1.default.createElement(Notification, { ref: function (ref) {
