...
function Popconfirm(baseProps, ref) {
    ...
    var renderPopconfirmContent = function () {
        ...
        return (react_1.default.createElement("div", { className: prefixCls + "-wrapper" },
            ...
            react_1.default.createElement("div", { className: prefixCls + "-btn" }, focusLock ? (react_1.default.createElement(react_focus_lock_1.default, { crossFrame: false, disabled: !popupVisible, autoFocus: !!autoFocus }, element)) : (element))));
    };
