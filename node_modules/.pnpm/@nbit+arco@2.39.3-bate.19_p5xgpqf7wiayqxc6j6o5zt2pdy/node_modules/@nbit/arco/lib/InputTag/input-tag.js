...
function InputTag(baseProps, ref) {
    ...
    var childrenWithAnimation = value
        ...
        react_1.default.createElement(input_element_1.default, { autoComplete: "off", size: size, disabled: disableInputComponent, readOnly: readOnly, ref: inputRef, autoFocus: autoFocus, placeholder: !value.length ? placeholder : '', prefixCls: prefixCls + "-input", autoFitWidth: {
