...
import { ERRO, ZegoResponse, ZegoRoomInfo, CdnPushConfig } from "./zego.entity";
...
export declare class StreamHandler {
    ...
    _sendCDNPublishByAccessSvr(streamId: string, cdnPushConfig: CdnPushConfig, success: (result: {
        errorCode: number;
        extendedData: string;
    }) => void, error: (err: {
        code: number;
