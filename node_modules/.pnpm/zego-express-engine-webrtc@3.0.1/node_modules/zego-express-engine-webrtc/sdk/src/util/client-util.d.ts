...
export declare function isTypeString(param: any): boolean;
...
export declare function logTrackStatus(track: MediaStreamTrack, logger: ZegoLogger, action: string): void;
/**
 * 当前设备是否为移动设备
 * @returns boolean
 */
...
export declare function getStreamByLocalStream(localstream: any, logger: ZegoLogger): MediaStream;
