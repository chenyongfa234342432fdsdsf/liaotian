...
export declare class NetAgentPCRequest {
    ...
    constructor(logger: ZegoLogger, service: BusinessService, streamManager: StreamManager, pcEstablishTimeout: number, option?: PCOption | undefined);
    /**
     * 发送长连接消息
     * @param body 长连接内容
     * @param failFunc 失败回调
