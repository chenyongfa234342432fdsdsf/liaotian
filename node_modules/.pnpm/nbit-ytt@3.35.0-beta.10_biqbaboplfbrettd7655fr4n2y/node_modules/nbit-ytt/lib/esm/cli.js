...
export async function run(cmd, options) {
  ...
  if (cmd === 'help') {
    ...
    await fs.outputFile(outputConfigFile, dedent`
    ...
    try {
      ...
      await ((_hooks = config.hooks) == null ? void 0 : _hooks.success == null ? void 0 : _hooks.success());
    } catch (err) {
      var _spinner, _generator, _config, _config$hooks;
      (_spinner = spinner) == null ? void 0 : _spinner.stop();
      await ((_generator = generator) == null ? void 0 : _generator.destroy());
      await ((_config = config) == null ? void 0 : (_config$hooks = _config.hooks) == null ? void 0 : _config$hooks.fail == null ? void 0 : _config$hooks.fail());
      /* istanbul ignore next */
      consola.error(err);
    }
    await ((_config2 = config) == null ? void 0 : (_config2$hooks = _config2.hooks) == null ? void 0 : _config2$hooks.complete == null ? void 0 : _config2$hooks.complete());
  }
}
