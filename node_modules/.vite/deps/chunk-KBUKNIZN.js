...
// node_modules/.pnpm/@tauri-apps+api@1.5.1/node_modules/@tauri-apps/api/chunk-FLLON6OW.js
var m = {};
e(m, { Child: () => c, Command: () => l, EventEmitter: () => i, open: () => g });
...
var l = class extends i {
  ...
  async spawn() {
    ...
    }, this.program, this.args, this.options).then((t) => new c(t));
  }
  async execute() {
...
//# sourceMappingURL=chunk-KBUKNIZN.js.map
