import {
  require_lodash
} from "./chunk-P5XXJ5F3.js";
import {
  __export,
  __toESM
} from "./chunk-Y7S7B2N7.js";

// node_modules/.pnpm/@nbit+utils@1.0.1-beta.49/node_modules/@nbit/utils/es/decimal/index.js
var decimal_exports = {};
...
var formatNumberDecimal = function formatNumberDecimal2(data) {
  ...
  var round2 = (0, import_lodash.isNumber)(isRound) ? isRound : isRound ? decimal_default.ROUND_HALF_UP : decimal_default.ROUND_DOWN;
  var result = getSafeDecimal(formatZeroPrefix(getSafeDecimal(data).toFixed(digits, round2), digits)).toFixed(digits, round2);
  if (!delPostZero) {
    return result;
  }
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.49/node_modules/@nbit/utils/es/market/index.js
var market_exports = {};
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.49/node_modules/@nbit/utils/es/fast-url/index.js
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.49/node_modules/@nbit/utils/es/security/index.js
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.49/node_modules/@nbit/utils/es/env/index.js
var env_exports = {};
...
var getBaseEnvS3Url = function getBaseEnvS3Url2(mode, type) {
  ...
  if (mode === EnvTypesEnum.test) {
    if (extType === ExtTypesEnum.im) {
      return getFastUrl2("https://im-s3-staging-saas.s3.ap-southeast-1.amazonaws.com/".concat(type));
    }
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.49/node_modules/@nbit/utils/es/vite-plugins/index.js
var vite_plugins_exports = {};
__export(vite_plugins_exports, {
  cssModuleHMR: () => cssModuleHMR
});

// node_modules/.pnpm/@nbit+utils@1.0.1-beta.49/node_modules/@nbit/utils/es/vite-plugins/css-hmr.js
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.49/node_modules/@nbit/utils/es/index.js
setPrecision(40);
export {
