...
(async () => {
  const { setImportBuildGetters } = await import('../../node_modules/.pnpm/vike@0.4.147_vite@4.5.0/node_modules/vike/dist/esm/node/runtime/globalContext/loadImportBuild.js');
