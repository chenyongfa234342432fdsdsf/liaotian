 ...
 * @更新时间 `2023-12-13 14:54:03`
 */
export interface YapiPostV1ImChatLoginAccountApiRequest {
  /**
   * 账号
   */
  uid: number
...
/**
 * 接口 [登录-账户方式↗](https://yapi.nbttfc365.com/project/82/interface/api/11754) 的 **返回类型**
 *
 * @分类 [用户模块↗](https://yapi.nbttfc365.com/project/82/interface/api/cat_802)
 * @请求头 `POST /v1/im/chat/login/account`
 * @更新时间 `2023-12-13 14:54:03`
 */
export interface YapiPostV1ImChatLoginAccountApiResponse {
  /**
   * token
   */
  token?: string
  ...
  userInfo?: YapiPostV1ImChatLoginAccountUserInfo
  usrMemberSettingsVO?: null
  imUserIndividual?: YapiPostV1ImChatLoginAccountImUserIndividual
  isWaiting?: boolean
  isSuccess?: boolean
  /**
   * zeGo聊天token
 ...
 * 用户基本信息
 */
export interface YapiPostV1ImChatLoginAccountUserInfo {
  /**
   * 商户ID
   */
  businessId?: number
 ...
 * 个性化设置
 */
export interface YapiPostV1ImChatLoginAccountImUserIndividual {
  id?: number
  /**
   * 商户ID
   */
...
// /**
// * [登录-账户方式↗](https://yapi.nbttfc365.com/project/82/interface/api/11754)
// **/
// export const postV1ImChatLoginAccountApiRequest: MarkcoinRequest<
//   YapiPostV1ImChatLoginAccountApiRequest,
//   YapiPostV1ImChatLoginAccountApiResponse['data']
// > = data => {
//   return request({
