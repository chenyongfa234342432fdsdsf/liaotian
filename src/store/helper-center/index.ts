...
import { getAnnouncementInfo, setAnnouncementInfo, removeAnnouncementInfo } from '@/helper/cache/helper-center'
...
const HeplerCenterSotre = create(devtools(getStore, { name: 'announcement-center-store' }))

const useHeplerCenterSotre = createTrackedSelector(HeplerCenterSotre)

export { useHeplerCenterSotre, HeplerCenterSotre }
